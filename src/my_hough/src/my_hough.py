...
def start():
    ...
    if True:
        ...
        ROI_ROW = int(HEIGHT * 0.52)
        ROI_HEIGHT = HEIGHT - ROI_ROW
        L_ROW = ROI_HEIGHT - int(HEIGHT * 0.25)
        ...
        cv2.waitKey()
        all_lines = cv2.HoughLinesP(edge_img, 1, math.pi/180, 2, 2, 2)
	...
	# Right original: 0:WIDTH
        ...
        cv2.rectangle(line_draw_img, (x_midpoint-5, L_ROW-5), (x_midpoint+5, L_ROW+5), (0, 255, 0), 4)
        cv2.rectangle(line_draw_img, (view_center-5, L_ROW-5), (view_center+5, L_ROW+5), (0, 255, 0), 4)
