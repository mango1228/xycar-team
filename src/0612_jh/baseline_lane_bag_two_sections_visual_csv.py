...
# -*- coding: utf-8 -*-
"""
baseline_lane_bag_two_sections_visual_csv.py

목적:
    하나의 rosbag에서 사용자가 코드 안에 지정한 여러 시간 구간만 골라서,
    현재 기본 차선 검출 알고리즘을 검증한다.
...
실행 예시:
    ...
    python3 baseline_lane_bag_two_sections_visual_csv.py \
...
TIME_SEGMENTS = [
    {
        "name": "lap1_problem_section_v0",
        "start_sec": 14.0,
        "end_sec": 80.0,
    },
    {
        "name": "lap2_problem_section_v0",
        "start_sec": 104.0,
        "end_sec": 115.0,
    },
]
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="rosbag 한 개에서 코드 내부 TIME_SEGMENTS 구간만 기본 차선 검출 분석 + 구간별 CSV 저장"
    )
